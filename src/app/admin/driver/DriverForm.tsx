      ...
      {operator.region && (
        <div className="">
          ...
          >
            ...
            {Object.keys(data[operator.region]).map((city) => (
      ...
      {operator.city && (
        <div className="">
          ...
          >
            ...
            {data[operator.region][operator.city].map((brgy) => (
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    {operator.emergency_region && (
      <div>
        ...
        >
          <option value="" disabled>Select City</option>
          {Object.keys(data[operator.emergency_region]).map((city) => (
            <option key={city} value={city}>
              {city}
            </option>
          ))}
    ...
    {operator.emergency_city && (
      <div>
        ...
        >
          <option value="" disabled>Select Barangay</option>
          {data[operator.emergency_region][operator.emergency_city].map((brgy) => (
            <option key={brgy} value={brgy}>
              {brgy}
            </option>
          ))}
